...
#_____________________________________________________________________________
# 2. Call the DISTATIS routine ----
#    with the array of distance (DistAlgo) as parameter
...
# Get the Factor Scores and Partial Factor Scores for the plot Routine
 ...
 GraphDistatisCpt(LeF,PartialFS, axis1 = 1, axis2 = 2,
                    ZeTitle= 'Distatis-Compromise',nude=FALSE)
 # 3.2. Have the graphs without legend for further editing
  GraphDistatisCpt(LeF,PartialFS,axis1 = 1, axis2 = 2, 
                     ZeTitle= 'Distatis-Compromise',nude=TRUE)
# Et voila ----  